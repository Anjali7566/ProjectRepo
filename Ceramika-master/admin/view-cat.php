...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-2"></div>
			<div class="col-md-8">
				<div class="col-md-12"><h2 class="text-center">View Category <a href="add-cat.php" class="btn btn-primary pull-right">Add Category</a></h2><br></div>
				<div class="">
			        ...
			        <tbody>
			        	...
			        	while($row = mysqli_fetch_array($res))
			        	{
			        		...
			        		echo '<td><a href="delete-cat.php?id='.$row['cat_id'].'" ><i class="fa fa-trash delete_fa"></i></a></td>';
			        		echo '</tr>';
			        		$i++;
			        	}
			        	?>
